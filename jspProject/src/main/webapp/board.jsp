	...
	<div id="main">
		...
		<table>
			...
			<tr>
				<td>${i.b_no }</td>
				<td id="tleft">
				<a href="./detail?b_no=${i.b_no }">${i.b_title  } 		<c:if test="${i.commentcount ne 0 }"><small>[${i.commentcount }]</small></c:if>
				 </a></td>
...
<!--	<c:choose>
      ...
      <button disabled="disabled" onclick="location.href='./board?pageNo=${pageNo -1}'">
		<img alt="" src="./assets/img/left.png">
	  </button>
    </c:if>
    ...
    <c:if test="${pageNo ne 1 }">
     ...
     <button disabled="disabled" onclick="location.href='./board?pageNo=${pageNo +1}'">  
     <img alt="" src="./assets/img/right.png"></button>
     </c:if>
